  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <a class="navbar-brand" href="#">
        <img src="https://firebasestorage.googleapis.com/v0/b/grizzly-5a659.appspot.com/o/smlogo.png?alt=media&token=9baaf384-9b6c-47e1-8d7a-ffbb30462f1c" alt="logo">
      </a>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3 bg-light">
          ...
          <br>
          <center>
            <img src="https://firebasestorage.googleapis.com/v0/b/grizzly-5a659.appspot.com/o/profile.png?alt=media&token=2c04d156-e6da-41c5-b726-e7301f660ac1" alt="Profile Picture" width="25%">
            <br>
            <br>
            <b> ${user.firstName}
            </b>
        ...
        <div class="col-md-6">
          <div class="container">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#home">MEDICINES
                </a>
              </li>
            </ul>
            <!-- Tab panes -->
                  ...
                  <div class="row">
                    <div class="col-md-8 bg-light   ">
                        ...
                        <center>
                          ...
                          <br>
                          <label for="files">
                            <img src="https://firebasestorage.googleapis.com/v0/b/grizzly-5a659.appspot.com/o/add.png?alt=media&token=f1289e0c-a25f-4631-ba58-96a8a2b36639"/>
                        </label>
                    ...
                    <div class="col-md-4">
                      <form class= "mx-2 my-auto w-full" action="AddMedicines.html" method="POST">
                        <input type="text" name="medId" placeholder="Enter Medicine ID" required>
                        <input type="text" name="medName" placeholder="Medicine Name" required>
                        <input type="text"  name="saltName" placeholder="Salt Name" required>
