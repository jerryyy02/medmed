                    ...
                    <div class="btn-group col-md-12">
                        <div class="container">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                              <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#home">Doctors</a>
                              </li>
                        ...
                        <div class="col-md-12 bg-light">
                                <form class="mx-2 my-auto d-inline w-20" action="searchDoc.html" method="POST">
                                        <div class="input-group">
                                            <input list="category" name="SearchBy" class="form-rounded" placeholder="Search By">
                                            <datalist id="category">
                                              <option value="By Name" selected>By Name</option>
                                              <option value="By Id">By Id</option>
                                              <option value="By Specialisation">By Specialisation</option>
                                             </datalist>    


                                                    &emsp;&nbsp;&nbsp;
                                                    <input type="text" name="Search" class="form-rounded border border-right-0" placeholder="Salt/Medicine/Brand">
                                                    <span class="input-group-append">
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <a href="view.html?id=${doctor.userId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								<input id="prodId" name="userId" type="hidden" value=${user.userId}>
								
                              <a  href="remove.html?id=${doctor.userId}" class="btn btn-secondary form-rounded">&nbsp;Remove&nbsp; 
                              </a>
                            </center>
                          </td>
                        </tr>
