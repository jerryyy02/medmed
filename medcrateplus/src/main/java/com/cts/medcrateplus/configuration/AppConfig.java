package com.cts.medcrateplus.configuration;
...
@ComponentScans(value = {@ComponentScan("com.cts.medcrateplus.dao"),
		@ComponentScan("com.cts.medcrateplus.service")})
...
//		sessionFactoryBean.setAnnotatedClasses(Login.class);
		sessionFactoryBean.setPackagesToScan("com.cts.medcrateplus.bean");
